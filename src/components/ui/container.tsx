...
const config = {
  ...
  variants: {
    variant: {
      ...
      four: "mx-auto max-w-7xl px-2 3xs:px-3 2xs:px-4 sm:px-6 lg:px-0", // full width on mobile constrained with padded content above
...
export const Container = ({ variant = "four", className, ...props }: Props) => {
